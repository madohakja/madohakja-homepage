...
import { V as VALID_INPUT_FORMATS } from './_astro_assets_BoNmq4-a.mjs';
import { A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, a as createComponent, u as unescapeHTML, b as renderTemplate, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderComponent } from './astro/server_CzGQMyQf.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_rV2G6njt.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://www.madohakja.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BoNmq4-a.mjs').then(n => n._);
